...
public class Input implements Closeable, Iterator<String>
{
  ...
  /**
   * The default constructor of an <code>com.ucl.spellchecker.Input</code> that assumes <code>System.in</code> is to
  ...
  /**
   * Constructor of an <code>com.ucl.spellchecker.Input</code> object given an <code>InputStream</code> object.
   */
  ...
  /**
   * A finalizer to ensure all files are closed if an <code>com.ucl.spellchecker.Input</code> object is garbage
   * collected.
   */
  ...
  {
    System.err.println("com.ucl.spellchecker.Input has been closed.");
    System.exit(1);
  }
  ...
  {
    System.err.println("com.ucl.spellchecker.Input did not represent " +
